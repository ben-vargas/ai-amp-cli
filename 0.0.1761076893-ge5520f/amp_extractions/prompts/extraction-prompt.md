...
Create the following files in `amp_extractions/prompts/`:

### 1. Smart Agent System Prompt
**File:** `smart-system-prompt.md`
...
**File:** `librarian-system-prompt.md`
