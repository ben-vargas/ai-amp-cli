# Smart Agent System Prompt (Main/Default Agent)

**Source:** `node_modules/@sourcegraph/amp/dist/main.js` (function `z90`, lines 399-623)
...
- Add middleware validation to check tokens on protected routes
...
Example:
Fixed auth crash in `auth.js` by guarding undefined user. `npm test` passes 148/148. Build clean. Ready to merge?
